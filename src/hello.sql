...
CREATE TABLE `accounts` (
  ...
  `pronouns` text NOT NULL COMMENT 'In case the user selects the "other" option in registration',
  `join_date` datetime NOT NULL COMMENT 'in UTC timezone',
...
CREATE TABLE `conversations` (
  ...
  `status` tinyint(1) NOT NULL COMMENT '0 for active, 1 for archived, ',
