    ...
    <div class="new-conversation-popup" id="newConvPopup">
        <div class="popup-container">
            ...
            <div class="popup-content">
                ...
                <fieldset>
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-0" class="num-fields" placeholder="0" maxlength="1">
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-1" class="num-fields" placeholder="0" maxlength="1">
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-2" class="num-fields" placeholder="0" maxlength="1">
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-3" class="num-fields" placeholder="0" maxlength="1">
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-4" class="num-fields" placeholder="0" maxlength="1">
                    <input type="text" pattern="/d*" autocomplete="off" name="num-code-5" class="num-fields" placeholder="0" maxlength="1">
                </fieldset>
                <br>
